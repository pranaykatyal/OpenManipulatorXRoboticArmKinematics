...
bool custom_messages__srv__velocity__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.srv._velocity.Velocity_Request", full_classname_dest, 46) == 0);
  }
  custom_messages__srv__Velocity_Request * ros_message = _ros_message;
  {  // q_1
...
PyObject * custom_messages__srv__velocity__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.srv._velocity");
...
ROSIDL_GENERATOR_C_EXPORT
bool custom_messages__srv__velocity__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.srv._velocity.Velocity_Response", full_classname_dest, 47) == 0);
  }
  custom_messages__srv__Velocity_Response * ros_message = _ros_message;
  {  // twist
