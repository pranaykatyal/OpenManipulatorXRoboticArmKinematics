...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__create()
{
  ...
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request * msg = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request));
  bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__init(msg);
  if (!success) {
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__destroy(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request * data = NULL;

  if (size) {
    data = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request *)allocator.zero_allocate(size, sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__fini(&data[i - 1]);
      }
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__fini(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * array = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__init(array, size);
  if (!success) {
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__destroy(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence__are_equal(const dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * lhs, const dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request * data =
      (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response * msg = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response));
  bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__destroy(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__init(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response * data = NULL;

  if (size) {
    data = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response *)allocator.zero_allocate(size, sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__fini(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * array = (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__destroy(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence__are_equal(const dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * lhs, const dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response * data =
      (dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__srv__GetCurrent_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
