...
#include "custom_messages/srv/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_messages::srv::Velocity_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::srv::Velocity_Request & ros_message)
{
  // Member: q_1
  cdr >> ros_message.q_1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages::srv::Velocity_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::srv::Velocity_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::srv::Velocity_Request *>(
    untyped_ros_message);
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, Velocity_Request)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_messages
cdr_serialize(
  const custom_messages::srv::Velocity_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: twist
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_messages::srv::Velocity_Response & ros_message)
{
  // Member: twist
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_messages::srv::Velocity_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_messages::srv::Velocity_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_messages::srv::Velocity_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, Velocity_Response)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity_Response__handle;
}
...
static rosidl_service_type_support_t _Velocity__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages, srv, Velocity)() {
  return &custom_messages::srv::typesupport_fastrtps_cpp::_Velocity__handle;
}
