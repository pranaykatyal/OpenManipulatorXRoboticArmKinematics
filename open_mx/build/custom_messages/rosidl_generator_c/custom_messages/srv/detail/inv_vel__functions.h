...
#ifndef CUSTOM_MESSAGES__SRV__DETAIL__INV_VEL__FUNCTIONS_H_
#define CUSTOM_MESSAGES__SRV__DETAIL__INV_VEL__FUNCTIONS_H_
...
/// Create srv/InvVel message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_messages__srv__InvVel_Request__init().
...
/// Destroy srv/InvVel message.
/**
 * It calls
 * custom_messages__srv__InvVel_Request__fini()
...
/// Check for srv/InvVel message equality.
/**
...
/// Initialize array of srv/InvVel messages.
/**
...
/// Finalize array of srv/InvVel messages.
/**
 * It calls
 * custom_messages__srv__InvVel_Request__fini()
...
/// Create array of srv/InvVel messages.
/**
 * It allocates the memory for the array and calls
 * custom_messages__srv__InvVel_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InvVel messages.
/**
 * It calls
 * custom_messages__srv__InvVel_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InvVel message array equality.
/**
...
/// Copy an array of srv/InvVel messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_messages__srv__InvVel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_messages
...
/**
 * It calls
 * custom_messages__srv__InvVel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_messages
...
/**
 * It allocates the memory for the array and calls
 * custom_messages__srv__InvVel_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_messages
...
/**
 * It calls
 * custom_messages__srv__InvVel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_MESSAGES__SRV__DETAIL__INV_VEL__FUNCTIONS_H_
